				...
				<div className="col-md-12 col-md-offset-0">
					<ul className="timeline animate-box">
						<li className="animate-box">
							<div className="timeline-badge" style="background-image:url(images/date1.jpg);"></div>
						...
						<li className="timeline-inverted animate-box">
							<div className="timeline-badge" style="background-image:url(images/date2.jpg);"></div>
							<div className="timeline-panel">
								<div className="timeline-heading">
						...
						<li className="animate-box">
							<div className="timeline-badge" style="background-image:url(images/date3.jpg);"></div>
							<div className="timeline-panel">
								<div className="timeline-heading">
